  ...
  <header id="menu1">
    <nav>
        <ul id="menu">
            ...
            <li id="link"><a id="logoapp"href="accueil.html"><img src="l/SITE/public/images/logoapp.png"/></a></li>
              ...
              <h2>En vigueur au 25/11/2020</h2>
                ...
                <h3 itemprop="name" style="margin-top:21px;"><br><br><br>ARTICLE 1 : Les mentions légales</h3>
                  <div itemprop="text">
                    ...
                    Le Directeur de la publication est : xxxxxxx<br>
                    <br>
                    L'hébergeur du site xxxxxxx.com est la société xxxxxxx, dont le siège social est situé au xxxxxxx, avec le numéro de téléphone : xxxxxxx.
                ...
                <h3 itemprop="name" style="margin-top:21px;"><br><br>ARTICLE 2 : Accès au site</h3>
                  <div itemprop="text">
                    ...
                    Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du site ou serveur et sous réserve de toute interruption ou modification en cas de maintenance, n'engage pas la responsabilité de xxxxxxx.com. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir rigueur à l’éditeur de toute interruption ou suspension de service, même sans préavis.<br>
                ...
                <h3 itemprop="name" style="margin-top:21px;"><br><br>ARTICLE 4 : Propriété intellectuelle</h3>
                  <div itemprop="text">
                    ...
                    <br>
                    <br>
                    La marque xxxxxxx est une marque déposée par _______________.Toute représentation et/ou reproduction et/ou exploitation partielle ou totale de cette marque, de quelque nature que ce soit, est totalement prohibée.<br>
                    <br>
                    <br>
                ...
                <h3 itemprop="name" style="margin-top:21px;"><br><br>ARTICLE 5 : Responsabilité</h3>
                  <div itemprop="text">
                    ...
                    <br>
                    <br>
                    Le site xxxxxxx.com ne peut être tenu pour responsable d’éventuels virus qui pourraient infecter l’ordinateur ou tout matériel informatique de l’Internaute, suite à une utilisation, à l’accès, ou au téléchargement provenant de ce site.<br>
                ...
                <h3 itemprop="name" style="margin-top:21px;"><br><br>ARTICLE 8 : Publication par l’Utilisateur</h3>
                  <div itemprop="text">
                    ...
                    Le membre reste titulaire de l’intégralité de ses droits de propriété intellectuelle. Mais en publiant une publication sur le site, il cède à la société éditrice le droit non exclusif et gratuit de représenter, reproduire, adapter, modifier, diffuser et distribuer sa publication, directement ou par un tiers
                    autorisé, dans le monde entier, sur tout support (numérique ou physique), pour la durée de la propriété intellectuelle. Le Membre cède notamment le droit d'utiliser sa publication sur internet et sur les réseaux de téléphonie mobile.<br>
